...
/* ======================= */
	...
	$('#bodyContent').html(''
		...
		+			'<textarea id="__art_content" name="bs" style="display: block;"></textarea>'
		+			'</form>'
		+			'</div>'
...
/* ======== */
	...
	{
		$R.article_content[0].innerHTML =$R.editor.getData();
	...
	$R.setOptions = function ()
	{
		...
		if (_resetOptions)
		{
			...
			var _cssText = (''
				...
				+	'#box { width: 700px; background-color: [=color_background]; } '
...
/* ============== */
	...
	$R.setContent=function()
	{
		...
		//$R.article_content[0].innerHTML = content_r;
	    $R.editor=CKEDITOR.replace('__art_content');
	    $R.editor.setData(content_r);
	}
	$R.show = function ()
	{
		//	debug
