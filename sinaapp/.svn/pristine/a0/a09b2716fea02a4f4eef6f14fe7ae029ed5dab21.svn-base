...
function receiveMessage(e) {
				if (e.data === "close") yApp.clipperManager.clipper.close(), yApp.removeClipDiv(), window.postMessage || (window.location = yApp.clipperManager.clipper.source);
					...
					t.style.cssText = "position:fixed;_position:absolute;right:20px; top:20px;padding:10px;color:#d98736;border:1px solid #ffebb4;background:#fffff6;border-radius:5px;z-index:999999;", t.innerHTML = "±£´æ³É¹¦", document.body.appendChild(t), setTimeout(function() {
...
var YWebClipperConfiguration = {
	logEnabled: !1,
	clipperBaseURL:  main_host+"plugins/jianbao2/",
	clipperUploadApp: "up2.php",
...
function() {
	...
	typeof YNote != "undefined" && (t = YNote), YNote = {}, YNote.Common = {
		...
		log: function(e) {
			if (!YWebClipperConfiguration.logEnabled) return !1;
			typeof console == "undefined" && (console = function() {
				var e = n.createElement("div");
				return e.style.cssText = "width:100%;height:500px;border:1pt solid black;position:absolute;left:0px;top:800px", e.innerHTML = '<textarea style="width:100%;height:450px" id="console_log"></textarea>', n.body.appendChild(e), {
					log: function(e) {
						n.getElementById("console_log").value += e + "\n"
					}
				}
			}());
		...
		styleForNode: function(e, t) {
			...
			if (e && e.nodeType && e.nodeType == 1) {
				...
				var s = "",
					o = {}, u = YWebClipperConfiguration.styleMerge;
		...
		crossDomain: function() {
			var e = {}, t, n, r = 1,
				...
				a = "addEventListener",
				f, l = s[u];
			return e.isFunction = function(e) {
				return Object.prototype.toString.call(e) === "[object Function]"
			}, e.browser = function() {
	...
	var r = null,
		...
		o = function() {
			...
			}, main_host), window.addEventListener ? window.addEventListener("resize", s) : window.attachEvent("onresize", s), s = function() {}, clearTimeout(r))
		};
