...
$cover=$article['cover'];
$mark=$article['mark'];
$host=preg_replace('/(http:\/\/[^\/]*\/).*/', '${1}', (isset($article['src'])?$article['src']:''));
}
?>
...
<script src="../plugins/ckeditor/adapters/jquery.js"></script>
  <div class="form-container">
	...
	<input type="hidden" name="host" id="" value="<? echo $host;?>"> 
	...
	<input type="text"  class="form-control" name="article_cover" id="" value="<? echo $cover;?>"/>
</div>
