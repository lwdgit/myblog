...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    private function upFile( $base64 )
    {
        ...
        $this->sae_img_name=$this->getName();
        $this->fullName = $this->getFolder() . '/' . $this->sae_img_name;
    ...
    public function getFileInfo()
    {
        return array(
            ...
            "name" => $this->fileName ,
            "url" => defined('SAE_TMP_PATH')?$this->sae_img_name:$this->fullName ,
            "size" => $this->fileSize ,
            "type" => $this->fileType ,
