...
$db->connect();
if(!check_login($db)){return "you not login!";}

if (!empty($_POST))
{
$artitle_title=isset($_POST['tl'])?$_POST['tl']:'无标题';
$article_content=addslashes(($_POST['bs']));
$article_author='网络';
$article_cover='images/article_cover.png';
$article_mark=isset($_POST['nb'])?$_POST['nb']:'';
