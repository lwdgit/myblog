...
(function ($R) {
	...
	$R.linksPath = 'http://127.0.0.1/';
	$R.path = 'http://127.0.0.1/plugins/jianbao/';
	$R.debug=false;
	...
	var 
		...
		+		'<script type="text/javascript" src="'+$R.linksPath+'js/jquery-1.8.min.js"></script>'
		+		'<script src="'+$R.linksPath+'/plugins/ckeditor/ckeditor.js"></script>'
		+		'<script src="'+$R.linksPath+'/plugins/ckeditor/adapters/jquery.js"></script>'
	...
	_divElement.setAttribute('id', 'readable_app_div');
	_divHtml='<button onclick="javascript:top.postMessage(\'close\',\'*\');">close</button>';
