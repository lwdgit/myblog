<?php /* Smarty version 2.6.27, created on 2014-03-17 16:13:32
         compiled from article_list_c.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate_utf', 'article_list_c.html', 8, false),array('modifier', 'date_format', 'article_list_c.html', 10, false),array('modifier', 'explode', 'article_list_c.html', 18, false),)), $this); ?>
<div class="catagory" style="background: url('<?php echo $this->_tpl_vars['article'][$this->_sections['i']['index']]['images']; ?>
') no-repeat;">
</div>
<div class="article_list">
  <div class="article_listt" id="article_listt">
  <a class="view" href="index.php?catalog=article&articleid=<?php echo $this->_tpl_vars['article'][$this->_sections['i']['index']]['id']; ?>
&show=1" title="点击浏览全文"></a>
  </div>
	<div class="article_listm"  id="article_listm">
			<div class="title" id="title"><a href="?catalog=article&articleid=<?php echo $this->_tpl_vars['article'][$this->_sections['i']['index']]['id']; ?>
&show=1" title="<?php echo $this->_tpl_vars['article'][$this->_sections['i']['index']]['title']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['article'][$this->_sections['i']['index']]['title'])) ? $this->_run_mod_handler('truncate_utf', true, $_tmp, 20, "..") : smarty_modifier_truncate_utf($_tmp, 20, "..")); ?>
</a>
			</div>
		...
		<div class="content">
	  <img src="<?php echo $this->_tpl_vars['article'][$this->_sections['i']['index']]['cover']; ?>
