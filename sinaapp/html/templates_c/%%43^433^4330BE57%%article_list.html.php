<?php /* Smarty version 2.6.27, created on 2014-03-17 16:58:12
...
<li><a href="?catalog=article_list&page=1" title="首页"><<</a></li> 
<li><a href="?catalog=article_list&page=<?php echo $this->_tpl_vars['cur_page']-1; ?>
" title="上一页"><</a></li>   
<?php endif; ?>
<?php if ($this->_tpl_vars['cur_page'] < $this->_tpl_vars['total_page']): ?>
<li><a href="?catalog=article_list&page=<?php echo $this->_tpl_vars['cur_page']+1; ?>
" title="下一页">></a></li> 
<li><a href="?catalog=article_list&page=<?php echo $this->_tpl_vars['total_page']; ?>
" title="尾页">>></a></li>
<?php endif; ?>
</ul>
</div>